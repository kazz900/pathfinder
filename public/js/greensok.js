...
var animateCanvas = function(sectionID, canvasID) {
    ...
    function initCanvas() {
        ...
        overviewSection = document.getElementById(sectionID);
        // overviewSection.style.height = height + 'px';
...
animateCanvas('overview', 'background-animation');